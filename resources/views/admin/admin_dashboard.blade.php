...
<head>
    ...
    <!-- Imageify -->
    <link href="{{ asset('adminBackend/assets/plugins/Drag-And-Drop/dist/imageuploadify.min.css') }}"
        rel="stylesheet" />
    <!-- tagsInput -->
    <link href="{{ asset('adminBackend/assets/plugins/input-tags/css/tagsinput.css') }}" rel="stylesheet" />
    <link href="{{ asset('adminBackend/assets/plugins/fancy-file-uploader/fancy_fileupload.css') }}"
        rel="stylesheet" />
