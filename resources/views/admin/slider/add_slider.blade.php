    ...
    <div class="page-content">
        <div class="container">
            <div class="page-title-box">
                <h5 class="page-title">{{ !empty($data) ? 'Edit' : 'Add' }} Slider</h5>
            ...
            <div class="main-body">
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('save.slider',@$data->id) }}" method="post" enctype="multipart/form-data" id="myForm">
                                @csrf
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-4 text-secondary form-group">
                                        ...
                                        <input type="file" name="image" class="dropify" data-plugins="dropify"
                                            data-height="150"
                                            data-default-file="{{ !empty($data->image) ? asset('uploads/backend/slider/' . $data->image) : url('uploads/img/no_image.jpg') }}" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
