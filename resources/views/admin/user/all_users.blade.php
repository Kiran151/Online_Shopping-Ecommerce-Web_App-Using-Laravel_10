                                    ...
                                    <tbody>
                                        @foreach ($data as $key => $item)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td>{{ $item->name }}</td>
                                                <td><img src="{{ !empty($item->image) ? asset('uploads/user_images/' . $item->image) : asset('uploads/img/no_image.jpg') }}"
                                                ...
                                                <td>
                                                    @if ($item->userOnline())
                                                    <span class="badge rounded-pill  bg-light-success text-success ">Active now</span>
                                                    @else
                                                    <span class="">{{Carbon\Carbon::parse($item->last_seen)->diffForHumans()}}</span>
                                                    @endif
                                                </td>
