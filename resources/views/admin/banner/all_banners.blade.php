                    ...
                    <div class="card  d-none">
                        <div class="card-body">
                            <div class="d-flex justify-content-end mb-2">
                                <a href="{{ route('add.banner') }}" class="btn btn-danger mb-2"><i
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="recent-product-img">
                                                        <img src="{{ !empty($item->image) ? asset('uploads/backend/banner/' . $item->image) : asset('uploads/img/no_image.jpg') }}"
                                                            alt="">
                                                    </div>
                                                </td>
                                                <td>{{ $item->title }}</td>
                                                ...
                                                <td>
                                                    <div class="d-flex order-actions">
                                                        <a href="{{ route('add.banner', $item->id) }}" class="bg-warning"><i
