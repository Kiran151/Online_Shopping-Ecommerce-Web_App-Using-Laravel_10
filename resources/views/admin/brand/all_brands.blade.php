                    ...
                    <div class="card  d-none">
                        <div class="card-body">
                            <div class="d-flex justify-content-end mb-2">
                                <a href="{{ route('add.brand') }}" class="btn btn-danger mb-2"><i
                                ...
                                <table id="example" class="table table-striped table-hover table-bordered"
                                    ...
                                    <tbody>
                                        @foreach ($data as $key => $item)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td><img src="{{ !empty($item->brand_image) ? asset('uploads/backend/brand/' . $item->brand_image) : asset('uploads/img/no_image.jpg') }}"
                                                        alt="image" class="img-fluid avatar-md rounded" height="40"
                                                        width="40"></td>
                                                <td>{{ $item->brand_name }}</td>
                                                <td>
                                                    <div class="d-flex order-actions">
                                                        <a href="{{ route('add.brand', $item->id) }}" class="bg-warning"><i
