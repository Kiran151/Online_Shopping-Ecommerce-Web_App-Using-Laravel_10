        ...
        <nav class="navbar navbar-expand">
            ...
            <div class="top-menu ms-auto">
                <ul class="navbar-nav align-items-center">
                    ...
                    @endphp
                    <li class="nav-item dropdown dropdown-large">
                        <a id="bell" class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative"
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="javascript:;">
                                <div class="msg-header">
                                    ...
                                    <a onclick="clear_all()" class="msg-header-clear ms-auto">Clear All</a>
                                </div>
                            </a>
                            <div id="notification_item" class="header-notifications-list">
                                ...
                                @forelse ($user->unreadNotifications as $notification)
                                    <a class="dropdown-item" href="javascript:;">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div  class="flex-grow-1">
                                                <h6 class="msg-name">New Order <span class="msg-time float-end">
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                    role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ !empty(auth()->user()->image) ? asset('uploads/admin_images/' . auth()->user()->image) : url('uploads/img/no_image.jpg') }}"
                        class="user-img" alt="user avatar">
                    <div class="user-info ps-3">
                        <p class="user-name mb-0">{{ auth()->user()->name }}</p>
                        <p class="designattion mb-0">
                            {{ auth()->user()->role == 'admin' ? 'Admin Head' : auth()->user()->role }}</p>
                    </div>
                </a>
