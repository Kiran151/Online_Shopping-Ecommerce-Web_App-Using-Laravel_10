...
@section('vendor')
                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="form-body mt-4">
                                <form action="{{ route('vendor.save.product', @$data->id) }}" method="post" id="myForm"
                                        ...
                                        <div class="col-lg-8">
                                            <div class="border border-3 p-4 rounded">
                                                ...
                                                @if (@$data == null)
                                                    ...
                                                    <div class="mb-3 form-group">
                                                        <label for="inputProductDescription"
                                                            class="form-label fw-bold">To Change Product Multiple Images</label>
                                                       <a href="{{route('edit.vendor.multi.images',@$data->id)}}" class="btn btn-primary">Click here</a>
    ...
    <script>
        $('#category').change(function() {
            ...
            $.ajax({
                'type': 'GET',
                'url': '{{ route('getvendorSubcategoryAjax') }}',
                'data': {
