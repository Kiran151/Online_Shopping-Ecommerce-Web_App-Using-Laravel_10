                ...
                <div class="header-right">
                    <div class="search-style-2" style="position: relative">
                        ...
                        <form action="{{route('product.search')}}" method="POST">
                            ...
                            <input onfocus="searchShow()" onblur="searchHide()" type="text" name="search" id="search-input" placeholder="Search for items..." />
                             
                           
                        </form>
                        <div id="dropdown-card" class="card shadow d-none w-50 mt-2">
                        ...
                        <div class="header-action-2">
                                ...
                                <a href="{{ route('compare') }}">
                                    <img class="svgInject" alt="Nest"
                                        ...
                                        if (Auth::check()) {
                                            ...
                                            $compare_count = App\Models\Compare::where('user_id', $user_id)->count();
                                        }else{
                                            $compare_count=0;
                                        }
                                    @endphp
                                    <span class="pro-count blue" id="wish_list_count">{{ $compare_count}}</span>
                                </a>
                            ...
                            <div class="header-action-icon-2">
                                <a href="{{ route('wishlist') }}">
                                    ...
                                    @endphp
                                    <span class="pro-count blue" id="wish_list_count">{{ $wishlist_count}}</span>
                                </a>
                            ...
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" href="{{route('mycart')}}">
                                    ...
                                    <span class="pro-count blue" id="mini_cart_count">2</span>
                                </a>
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    ...
                                    <div class="shopping-cart-footer">
                                        <div class="shopping-cart-total">
                                            <h4>Total <span id="mini_cart_total">$4000.00</span></h4>
                                        </div>
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <a href="#"><span
                                        class="lable ml-0">{{ Auth::check() ? auth()->user()->name : 'Account' }}</span></a>
                                        ...
                                        @else
                                            <li>
                                                <a href="{{ route('user.login') }}"><i
                                                        class="fi fi-rs-sign-out mr-10"></i>Login</a>
                                            </li>
                                            <li>
                    ...
                    <div class="main-categori-wrap d-none d-lg-block">
                        ...
                        <div class="categories-dropdown-wrap categories-dropdown-active-large font-heading">
                            <div class="d-flex categori-dropdown-inner">
                                @php
                                    $categories1 = App\Models\Category::orderBy('id', 'ASC')
                                        ->limit(5)
                                        ->get();
                                @endphp
                                <ul>
                                ...
                                @php
                                    $categories2 = App\Models\Category::orderBy('id', 'ASC')
                                        ->skip(5)
                                        ->take(5)
                                        ->get();
                                @endphp
                        ...
                        <nav>
                            <ul>
                                ...
                                @foreach ($category as $item)
                                    <li>
                                        <a href="{{ url("products/category/$item->id/$item->category_slug") }}">{{ $item->category_name }}
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            @foreach ($subcategories as $item)
                                                <li><a
                                                        href="{{ url("products/subcategory/$item->id/$item->subcategory_slug") }}">{{ $item->subcategory_name }}</a>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </li>
                                ...
                                <li>
                                    <a href="{{route('frontend.blogs')}}">Blogs&news</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
    ...
    <div class="mobile-header-wrapper-inner">
        ...
        <div class="mobile-header-content-area">
            <div class="mobile-search search-style-3 mobile-header-border">
                <form action="#">
                    <input type="text" name="searc" placeholder="Search for items…" />
